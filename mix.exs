defmodule TestNervesCustomRpi0Opencv.Mixfile do
  use Mix.Project
  ...
  def project do
    [app: :test_nerves_custom_rpi0_opencv,
     version: "0.1.0",
     elixir: "~> 1.4",
     target: @target,
  ...
  # invoke TestNervesCustomRpi0Opencv.start/2 when running on a target.
  def application("host") do
    [extra_applications: [:logger]]
  end
  def application(_target) do
    [mod: {TestNervesCustomRpi0Opencv.Application, []},
     extra_applications: [:logger]]
  end
  ...
  def system("nerves_custom_rpi0_opencv"), do: [{:nerves_custom_rpi0_opencv, path: "../nerves_custom_rpi0_opencv", runtime: false}]
